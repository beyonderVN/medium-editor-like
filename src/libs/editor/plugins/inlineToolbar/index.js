...
const inlineToolbarPlugin = createInlineToolbarPlugin({
  theme: {
    buttonStyles: {
      button: "w-10 h-10 flex justify-center items-center",
      active: "text-blue-600",
    },
    toolbarStyles: {
      toolbar: "draftJsToolbar_inline___toolbar",
    },
  },
});
const BoldButton = createInlineStyleButton({
  style: "BOLD",
  children: (
    <svg fill="currentColor" width={21} height={21}>
      <path
  ...
  <inlineToolbarPlugin.InlineToolbar>
    {
      ...
      (externalProps) => (
        <>
          ...
          <HeadOneButton {...externalProps} />
          <HeadTwoButton {...externalProps} />
